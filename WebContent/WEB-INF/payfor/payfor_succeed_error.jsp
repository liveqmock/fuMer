...
<s:if test="#fileRows > 0">
	...
	url="${pageContext.request.contextPath}/payfor/payFor_executePayForBtnType.action?btnType=OK&uploadFileName=${fileNam}&busiCd=${busiCd}" />
&nbsp;&nbsp;<input type="button" value="取消" onClick="ver_del(this)" Class="type_button"
	url="${pageContext.request.contextPath}/payfor/payFor_executePayForBtnType.action?btnType=NO&uploadFileName=${fileNam}&busiCd=${busiCd}" />
</s:if>
 </div>
</body>
</html>