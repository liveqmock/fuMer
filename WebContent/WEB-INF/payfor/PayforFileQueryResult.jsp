			...
			<tr>
			    ...
			    <s:else>
					...
					<td align="center" nowrap="nowrap" class='tr1'>
						...
						<s:if test="FILE_ST == 0">
<a href='${pageContext.request.contextPath}/payfor/payFor_executePayForBtnType.action?btnType=OK&uploadFileName=<s:property value="FILE_NM"/>' target="blank">确认&nbsp;|&nbsp;</a>
						</s:if>
						<s:else>
							确认&nbsp;|&nbsp;
						</s:else>
						<s:if test="FILE_ST == 0 || FILE_ST == 1">
							<a href='${pageContext.request.contextPath}/payfor/payFor_executePayForBtnType.action?btnType=NO&uploadFileName=<s:property value="FILE_NM"/>&busiCd=<s:property value="#request.fileBusiTp"/>' target="blank">删除&nbsp;|&nbsp;</a>
						</s:if>
						<s:else>
							删除&nbsp;|&nbsp;
						</s:else>
