...
${message }
<br><br>
<input type="button" value="确认" onclick="Javascript:return confirm('确定要删除吗？')" cssClass="type_button" /> 
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
<input type="button" value="取消" onclick="Javascript:return confirm('确定要删除吗？')" cssClass="type_button" /> <br>
</div>
</body>
</html>