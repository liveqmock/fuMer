	...
	<div class="table">
     <table  class="tableBorder" border="0" cellpadding="0" cellspacing="0" align="center">
    	 <tr>
			...
			<td align="center" nowrap="nowrap" class='title'>金额(元)</td>
		...
		<page:pager total="<%=totalRecords %>">
			...
			<tr>
			    ...
			    <s:else>
					...
					<td align="center" nowrap="nowrap" class='tr2'>批量文件</td>
					<td align="center" nowrap="nowrap" class='tr1'><s:property value="OPR_USR_ID" /></td>
					<td align="center" nowrap="nowrap" class='tr2'><s:property value="RESERVE1" /></td>
					...
					<td align="center" nowrap="nowrap" class='tr1'>
					    ...
					    <a href='${pageContext.request.contextPath}/payfor/PayforReviewAction_fileReview.action?&KBPS_SRC_SETTLE_DT=<s:property value="FILE_DT"/>&uploadFileName=<s:property value="FILE_NM"/>&fileBusiTp=<s:property value="#request.fileBusiTp"/>'>复核&nbsp;|&nbsp;</a>
					    
					    <a href='${pageContext.request.contextPath}/payfor/payFor_executePayForBtnType.action?btnType=NO&uploadFileName=<s:property value="FILE_NM"/>&busiCd=<s:property value="#request.fileBusiTp"/>' >复核不通过&nbsp;|&nbsp;</a>
