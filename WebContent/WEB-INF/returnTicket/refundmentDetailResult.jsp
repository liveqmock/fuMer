...
<table class="tableBorder" border="0">
	...
	<tr>
		<td align="left" nowrap="nowrap" bgcolor="#e8eef7" class="tr1" >商户复核时间  </td>
		<td class="tr1" nowrap="nowrap" align="left" >${tApsTxnLogMap.mchnt_review_ts}&nbsp;</td>
	</tr>
	<tr>
		<td align="left" nowrap="nowrap" bgcolor="#e8eef7" class="tr1" >交易发送时间  </td>
		<td class="tr1" nowrap="nowrap" align="left" >${tApsTxnLogMap.to_ts}&nbsp;</td>
	</tr>
	<s:if test="#tApsTxnLogMap.chnl_review_ts !=null ">
		<tr>
			<td align="left" nowrap="nowrap" bgcolor="#e8eef7" class="tr1" >渠道资金到账时间  </td>
			<td class="tr1" nowrap="nowrap" align="left" >${tApsTxnLogMap.chnl_review_ts}&nbsp;</td>
		</tr>	
	</s:if>
	<tr>
	...
	<s:if test="#tApsTxnLogMap.BUSI_CD!='AP01'">
		<tr>
