			...
			<s:iterator value="#request.fileList" id="trade" status="trade">
			    ...
			    <s:else>
					...
					<td align="center" nowrap="nowrap" class='tr1'>
						...
						<s:if test="FILE_RSLT_ST == 2">
							<a href='VerifyFileDownload.action?fileName=<s:property value="FILE_RSLT_NM"/>&savePath=<s:property value="FILE_PATH"/>&fileSffx=.txt'>下载结果文件</a>
						</s:if>
						<s:else>
							下载结果文件
						</s:else>
